    ...
    <header class="masthead">
        <div class="container-fluid px-4 px-lg-5" style="height: 650px;">
            <div class="container d-flex justify-content-around align-items-center" style=" height: 70px; width: 300px;">
                <a href="{{ url('logement/create') }}"><img style="width: 50px; height: 50px;" src="assets/img/add.png"></a>
            </div>
            <div class="container h-100 align-items-center justify-content-center text-center" >
               ...
               <table id="myTable" class="table table-dark">
                ...
                <tbody>
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        <td id="num_logement">{{ $logement->num_logement}}</td>
                        <td>{{ $logement->type_vente }}</td>
                        <td>{{ $logement->terrain }}</td>
                        <td>{{ $logement->prix }}</td>
                        <td>


                            <a class="btn" href="{{ url('logement/'. $logement->id) }}"><img style="width: 20px; height: 20px;" src="assets/img/view.png"></a>
                            <a class="btn" href="{{ url('logement/'. $logement->id .'/edit') }}"><img style="width: 20px; height: 20px;" src="assets/img/edit.png"></a>
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{ url('logement/'. $logement->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
