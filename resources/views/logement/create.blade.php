    ...
    <header class="masthead">
        <div class="container-fluid px-4 px-lg-5" style="height: 650px;">
            ...
            <div class="container align-items-center justify-content-center text-center" style=" width: 400px; height: 400px;">
                ...
                <form action="{{ url('logement/') }}" method="POST">
                    @csrf

                    <div class="form-group mb-3">
                        <label for="num_logement">Numéro Logement:</label>
                        <input type="text" class="form-control" id="num_logement" name="num_logement" value="">
                    </div>

                    <div class="form-group mb-3">

                        <label for="type_vente">Type de vente:</label>
                        <input type="text" class="form-control" id="type_vente" name="type_vente" value="">

                    </div>

                    <div class="form-group mb-3">
                        <label for="terrain">Terrain:</label>
                        <input type="text" class="form-control" id="terrain" name="terrain" value="">
                    </div>
