    ...
    <header class="masthead">
        <div class="container-fluid px-4 px-lg-5" style="height: 650px;">
            <div class="container d-flex justify-content-around align-items-center" style=" height: 70px; width: 300px;">
                <a href="{{ url('client/create') }}"><img style="width: 50px; height: 50px;" src="assets/img/add.png"></a>
            </div>
            <div class="container h-100 align-items-center justify-content-center text-center" >
             ...
             <table id="myTable" class="table table-dark">
                ...
                <tbody>
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        <td id="nom_ag">{{ $client->nom_client}}</td>
                        <td>{{ $client->adresse_client }}</td>
                        <td>{{ $client->lieu_travail }}</td>
                        <td>


                            <a class="btn" href="{{ url('client/'. $client->id) }}"><img style="width: 20px; height: 20px;" src="assets/img/view.png"></a>
                            <a class="btn" href="{{ url('client/'. $client->id .'/edit') }}"><img style="width: 20px; height: 20px;" src="assets/img/edit.png"></a>
