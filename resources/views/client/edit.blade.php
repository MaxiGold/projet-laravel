   ...
   <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    ...
    <form method="post" action="{{ url('client/'. $client->id) }}" >
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="adresse_client" name="adresse_client" value="{{ $client->adresse_client }}">

        </div>

        <div class="form-group mb-3">

            <label for="lieu_travail">Lieu travail:</label>
            <input type="text" class="form-control" id="lieu_travail" name="lieu_travail" value="{{ $client->lieu_travail }}">
