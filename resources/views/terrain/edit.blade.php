    ...
    <header class="masthead">
        <div class="container-fluid px-4 px-lg-5" style="height: 650px;">
            ...
            <div class="container align-items-center justify-content-center text-center" style=" width: 400px; height: 500px;">
                ...
                <form method="post" action="{{ url('terrain/'. $terrain->id) }}" >
                    @method('PATCH')
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="num_terrain" name="num_terrain" value="{{ $terrain->num_terrain }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="emplacement" name="emplacement" value="{{ $terrain->emplacement }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="superficie" name="superficie" value="{{ $terrain->superficie }}">
