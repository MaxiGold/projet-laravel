    ...
    <header class="masthead">
        <div class="container-fluid px-4 px-lg-5" style="height: 650px;">
            ...
            <div class="container align-items-center justify-content-center text-center" style=" width: 400px; height: 400px;">
                ...
                <form action="{{ url('agence/') }}" method="POST">
                    @csrf

                    <div class="form-group mb-3">
                        <label for="nom_ag">Nom Agence:</label>
                        <input type="text" class="form-control" id="nom_ag" name="nom_ag" value="">
                    </div>

                    <div class="form-group mb-3">

                        <label for="nom_cite">Nom Cité:</label>
                        <input type="text" class="form-control" id="nom_cite" name="nom_cite" value="">
