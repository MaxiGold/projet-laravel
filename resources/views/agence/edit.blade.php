...
@section('content')
   ...
   <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    ...
    <form method="post" action="{{ url('agence/'. $agence->id) }}" >
        @method('PATCH')
        @csrf
        ...
        <div class="form-group mb-3">
            ...
            <label for="nom_ag">Nom Agence:</label>
            <input type="text" class="form-control" id="nom_ag" name="nom_ag" value="{{ $agence->nom_ag }}">

        </div>

        <div class="form-group mb-3">

            <label for="nom_cite">Nom Cité:</label>
            <input type="text" class="form-control" id="nom_cite" name="nom_cite" value="{{ $agence->nom_cite }}">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="province" name="province" value="{{ $agence->province }}">
